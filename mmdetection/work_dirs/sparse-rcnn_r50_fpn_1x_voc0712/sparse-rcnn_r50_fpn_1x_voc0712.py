...
launcher = 'pytorch'
load_from = 'sparse_rcnn_r50_fpn_1x_coco_20201222_214453-dc79b137.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    ...
    type='OptimWrapper')
optimizer = dict(lr=5e-05, momentum=0.9, type='AdamW', weight_decay=0.0001)
...
test_evaluator = dict(
    ann_file='data/VOCdevkit/coco/voc12_val.json',
    backend_args=None,
    classwise=True,
    format_only=False,
    metric=[
...
train_dataloader = dict(
    ...
    batch_size=8,
    dataset=dict(
        ann_file='coco/voc12_train.json',
        backend_args=None,
        data_prefix=dict(img=''),
        data_root='data/VOCdevkit/',
...
work_dir = './work_dirs/sparse-rcnn_r50_fpn_1x_voc0712'
